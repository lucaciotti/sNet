...
class CreateTableMcarp01Sysbuyofkk extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('w_mcarp01_sysBuyOfKK', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('w_mcarp01_sysBuyOfKK');
    }
}
